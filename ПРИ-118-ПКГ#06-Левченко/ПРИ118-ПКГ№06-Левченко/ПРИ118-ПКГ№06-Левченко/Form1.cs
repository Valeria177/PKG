...
namespace ПРИ118_ПКГ_06_Левченко
{
    public partial class Form1 : Form
    {
        ...
        {
            ProgrammDrawingEngine.SetStandartBrush(20);
        }
        ...
        {
            ProgrammDrawingEngine.SetBrushFromFile("brushLera.bmp");
        }
        ...
        private void кистьПРИ118ToolStripMenuItem_Click(object sender, EventArgs e)
        {
