...
namespace ПРИ_118_ПКГ_09_Левченко
{
    public partial class Form1 : Form
    {
        ...
        private float[,] GeomObject = new float[37, 3];

        private int count_elements = 0;

        //начальный угол поворота, константы переноса и масштабирования
        private float angle_of_rotation = (float)3.14;
        private float Tx = 1.50f;
        private float Ty = 0f;
        private float Sx = 0.5f;
        private float Sy = 2.5f;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            GeomObject[10, 0] = -0.4f;
            GeomObject[10, 1] = 1.3f;
            GeomObject[10, 2] = 0.0f;

            GeomObject[11, 0] = 0.0f;
            GeomObject[11, 1] = 1.3f;
            GeomObject[11, 2] = 0.0f;

            GeomObject[12, 0] = 0.0f;
            GeomObject[12, 1] = 1.2f;
            GeomObject[12, 2] = 0.0f;

            GeomObject[13, 0] = -0.4f;
            GeomObject[13, 1] = 1.2f;
            GeomObject[13, 2] = 0.0f;

            GeomObject[14, 0] = -0.4f;
            GeomObject[14, 1] = 0.8f;
            GeomObject[14, 2] = 0.0f;

            GeomObject[15, 0] = 0.0f;
            GeomObject[15, 1] = 0.8f;
            GeomObject[15, 2] = 0.0f;

            GeomObject[16, 0] = 0.0f;
            GeomObject[16, 1] = 0.7f;
            GeomObject[16, 2] = 0.0f;

            GeomObject[17, 0] = -0.4f;
            GeomObject[17, 1] = 0.7f;
            GeomObject[17, 2] = 0.0f;

            GeomObject[18, 0] = -0.4f;
            GeomObject[18, 1] = 0.4f;
            GeomObject[18, 2] = 0.0f;

            GeomObject[19, 0] = -0.2f;
            GeomObject[19, 1] = 0.4f;
            GeomObject[19, 2] = 0.0f;

            GeomObject[20, 0] = -0.2f;
            GeomObject[20, 1] = 0.3f;
            GeomObject[20, 2] = 0.0f;

            GeomObject[21, 0] = 0.0f;
            GeomObject[21, 1] = 0.3f;
            GeomObject[21, 2] = 0.0f;

            //квадраты

            GeomObject[23, 0] = -0.3f;//
            GeomObject[23, 1] = 1.7f;
            GeomObject[23, 2] = 0.0f;

            GeomObject[24, 0] = 0.1f;//
            GeomObject[24, 1] = 1.7f;
            GeomObject[24, 2] = 0.0f;

            GeomObject[25, 0] = 0.1f;//
            GeomObject[25, 1] = 1.4f;
            GeomObject[25, 2] = 0.0f;

            GeomObject[26, 0] = -0.3f;
            GeomObject[26, 1] = 1.4f;
            ...
            GeomObject[28, 0] = 0.3f;
            GeomObject[28, 1] = 0.2f;
            GeomObject[28, 2] = 0.0f;

            GeomObject[29, 0] = 0.7f;
            GeomObject[29, 1] = 0.2f;
            GeomObject[29, 2] = 0.0f;

            GeomObject[30, 0] = 0.7f;
            GeomObject[30, 1] = 0.6f;
            GeomObject[30, 2] = 0.0f;

            GeomObject[31, 0] = 0.3f;
            GeomObject[31, 1] = 0.6f;
            GeomObject[31, 2] = 0.0f;



            GeomObject[33, 0] = 0.2f;
            GeomObject[33, 1] = 0.8f;
            GeomObject[33, 2] = 0.0f;

            GeomObject[34, 0] = 0.4f;
            GeomObject[34, 1] = 0.8f;
            GeomObject[34, 2] = 0.0f;

            GeomObject[35, 0] = 0.4f;
            GeomObject[35, 1] = 1.1f;
            GeomObject[35, 2] = 0.0f;

            GeomObject[36, 0] = 0.2f;
            GeomObject[36, 1] = 1.1f;
